...
public class OtsRowHelper {
	private static Logger logger = LoggerFactory.getLogger(OtsRowHelper.class);
	 ...
	 * @return 添加行操作的结果
	 */
	public static PutRowResult putRow(final OtsRequestParam requestParam, final RowPutChange rowPutChange) {
		...
		do {
			...
			try {
				...
				if (retryCnt == 10) {
					logger.error("插入行操作不成功，重试次数达到上限。");
					throw e;
				}
	 ...
	 * @return 添加行操作的结果
	 */
	public static PutRowResult putRowWithClient(final OTSClient client, final RowPutChange rowPutChange) {
	 ...
	 * @return OTS行修改的结果
	 */
	public static UpdateRowResult updateRow(final OtsRequestParam requestParam, final RowUpdateChange rowUpdateChange) {
	 ...
	 * @return OTS行修改的结果
	 */
	public static UpdateRowResult updateRowWithCLient(final OTSClient client, final RowUpdateChange rowUpdateChange) {
		Preconditions.checkNotNull(rowUpdateChange.getTableName(), "表名不能为空");
		Preconditions.checkNotNull(rowUpdateChange.getRowPrimaryKey(), "表主键设置不能为空");
		Preconditions.checkNotNull(rowUpdateChange.getCondition(), "主键重复判断条件不能为空");
	 ...
	 * @return OTS行删除的结果
	 */
	public static DeleteRowResult deleteRow(final OtsRequestParam requestParam, RowDeleteChange rowDeleteChange) {
	 ...
	 * @return OTS行删除的结果
	 */
	public static DeleteRowResult deleteRowWithClient(final OTSClient client, RowDeleteChange rowDeleteChange) {
	 ...
	 * @return OTS行查询结果
	 */
	public static GetRowResult getRow(final OtsRequestParam requestParam, final SingleRowQueryCriteria criteria) {
	 ...
	 * @return OTS行查询结果
	 */
	public static GetRowResult getRowWithClient(final OTSClient client, final SingleRowQueryCriteria criteria) {
	 ...
	 * @return 返回插入失败的操作列表
	 */
	public static List<RowPutChange> batchWriteRow(final OtsRequestParam requestParam,
			final List<RowPutChange> rowPutChanges) {
	 ...
	 * @return 返回插入失败的操作列表
	 */
	public static List<RowPutChange> batchWriteRowWithClient(OTSClient client, final List<RowPutChange> rowPutChanges) {
		BatchWriteRowRequest request = new BatchWriteRowRequest();
		for (RowPutChange rowPutChange : rowPutChanges) {
			Preconditions.checkNotNull(rowPutChange.getTableName(), "表名不能为空");
			Preconditions.checkNotNull(rowPutChange.getRowPrimaryKey(), "表主键设置不能为空");
	 ...
	 * @return OTS范围查询结果
	 */
	public static GetRangeResult getRange(final OtsRequestParam requestParam,
			RangeRowQueryCriteria rangeQueryCriteria) {
		OTSClient client = null;
	 ...
	 * @return OTS范围查询结果
	 */
	public static GetRangeResult getRangeWithClient(final OTSClient client, RangeRowQueryCriteria rangeQueryCriteria) {
		GetRangeRequest request = new GetRangeRequest(rangeQueryCriteria);
		return client.getRange(request);
	}
